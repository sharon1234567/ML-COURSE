...
model = gensim.models.Doc2Vec.load("E:/03-NLP课程/课程作业/Lesson-8/Doc2vec.d2v")
...
RF = RandomForestClassifier(n_estimators = 5000, n_jobs = 4, oob_score = True)
RF.fit(X_train,y_train)

ACC_train_LR = ACC(y_train, clf.predict(X_train))  # 90.8% 
ACC_train_RF = ACC(y_train, RF.predict(X_train))   # 100%
ACC_test_LR = ACC(y_test, clf.predict(X_test))  # 91.5%
ACC_test_RF = ACC(y_test, RF.predict(X_test))   # 91.7%
